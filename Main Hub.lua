...
MainSection:NewSlider("Jump Power", "Jump Power for humanoid", 500, 50, function(v) -- 500 (MaxValue) | 0 (MinValue)
...
MainSection:NewButton("Fly[F]", "F to Fly", function()
    repeat wait() 
...
MainSection:NewButton("God mode", "Reset to take god mode off", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/XF0j0Ups"))()
end)

MainSection:NewButton("Invis[N]", "N for invis", function()
    local ScriptStarted = false
local Keybind = "n" --Set to whatever you want, has to be the name of a KeyCode Enum.
...
MainSection:NewButton("Force Reset", "Make character reset", function()
...
local FeSection = Tab:NewSection("FE Stuff")

FeSection:NewButton("Netless", "Activate before using eny FE", function()
...
FeSection:NewButton("Permdeath renim", "Just in case", function()
...
local function NoclipLoop1()
	for _, v in pairs(lplrChar:GetDescendants()) do
		if v:IsA("BasePart") and v.CanCollide == true and v.Name ~= "Handle" then
			v.CanCollide = false
		end
	end
end
...
FeSection:NewButton("Scythe", "U need Void Scythe", function()
    --//====================================================\\--
--||			   CREATED BY SHACKLUSTER
--\\====================================================//--
local Player = game:GetService("Players").LocalPlayer
local bodyPos = Player.Character:WaitForChild("RealRoot").BodyPosition
...
do
	...
	Event.Event:Connect(function(plr,io)
...
function Banish(Foe)
	if Foe then
		if Foe:FindFirstChild("Head") then
			bodyPos.Position = Foe.Head.Position
			delay(1,function()
...
if Character:FindFirstChild("VoidScythe") then
	local serverScythe = Character:WaitForChild("VoidScythe").Handle
	local alpos = Instance.new("AlignPosition",serverScythe)
	local alori = Instance.new("AlignOrientation",serverScythe)
	local att0 = Instance.new("Attachment",serverScythe)
	local att1 = Instance.new("Attachment",HitBox)
	alpos.Attachment0 = att0
	alpos.Attachment1 = att1
	alori.Attachment0 = att0
	alori.Attachment1 = att1
	alori.MaxTorque = 1000000000
	alori.Responsiveness = 200
	alpos.MaxForce = 1000000000
	alpos.Responsiveness = 200
	
	att1.Position = Vector3.new(0, 0.05, 0.95)
	att1.Orientation = Vector3.new(0, 90, -40)
	serverScythe.Anchored = false
end
...
FeSection:NewButton("Fe Grapplers[E-Q] (R6)", "E and Q to use btw!", function()
...
FeSection:NewButton("R6 Fling[G]", "R6 Fling", function()
    ...
    Mouse.KeyDown:connect(function(Key)
    if Key:lower() == "Colon" and not DB then
    DB = true
...
FeSection:NewButton("Jojo Stand click on the 3 dots (Only R6) --->", "The Items you need (all free) -Lavender-Updo Pal-Hair ROBLOX-Girl-Hair(bundle) Red-Roblox-Cap Brown-Hair Chestnut-Bun(Bundle) Robox", function()
    --[[
...
FeSection:NewButton("FE slasher", "Requires slasher", function()
   --amogus
for i,v in next, game:GetService("Players").LocalPlayer.Character:GetDescendants() do
    if v:IsA("BasePart") and v.Name ~="HumanoidRootPart" then 
    game:GetService("RunService").Heartbeat:connect(function()
...
FeSection:NewButton("Fe sniper", ":)", function()
...
anims()
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Edit",Text = "kezmme#0001",Duration = 12})end)



if game.PlaceId == 4723618670 then
local Tab = Window:NewTab("Wisteria [Alpha]")
local FarmSection = Tab:NewSection("Farm Stuff")
local AutoSection = Tab:NewSection("Some auto stuff")


AutoSection:NewToggle("Inf fish", "Sell for money", function(state)
    if state then
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2351.92, 6.1803, -136.949)
    wait(5)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(2534.45, 3.98059, -362.836)
    local FishFarm = true
    while FishFarm ==  true do
        wait(1)
        local args = {
        [1] = {
            ["won"] = true,
        ...
        game:GetService("Players").LocalPlayer.Backpack.Fishing:FireServer(unpack(args))
        end
    else
        local FishFarm = false
        game.Players.LocalPlayer.Character.Humanoid.Health = 0
    end
end)
    
    
    AutoSection:NewToggle("Auto Sharpen", "Auto Sharpen", function(state)
        if state then
            Sharpen = true
            while Sharpen == true do
                wait()
                game:GetService("ReplicatedStorage").Events.Sharpen:FireServer()
            end
        else
            Sharpen = false
            wait()
...
if game.PlaceId == 5551657553 then 
    local Tab = Window:NewTab("Business Legends")
    local AutofarmSection = Tab:NewSection("Auto Farm")

    AutofarmSection:NewButton("Auto Farm", "Auto Farm", function()
        local Event = game:GetService("ReplicatedStorage").Events.JobEvent
while wait() do
for i = 1,10 do
Event:FireServer("Work", i)
Event:FireServer("Level", i)
end
end
    end)
    ...
    AutofarmSection:NewToggle("Auto rebirth", "Auto rebirths", function(state)
    if state then
        AutoR = true
        while AutoR == true do
            wait()
        game:GetService("ReplicatedStorage").Events.DoRebirth:FireServer()
        end    
    else
        AutoR = false
        while AutoR == true do
    ...
    local AutoFpetSection = Tab:NewSection("Normal World pets")

    AutoFpetSection:NewToggle("Auto farm best pets (Normal World)", "just auto farms pets and delets the bad pets", function(state)
        if state then
            AutoBuy = true
            while AutoBuy == true do
                wait()
                local args = {
                    [1] = workspace.PetGivers.SpawnPetShop1
                }
                
                game:GetService("ReplicatedStorage").Events.BuyPet:FireServer(unpack(args))
    ...
    AutoFpetSection:NewToggle("Delete all normal world pets but not the Bear", "Delete all normal world pets but not the Bear", function(state)
        if state then
            Autodel = true
            while Autodel == true do
            -- cat 
local args = {
    [1] = "Destroy",
    [2] = {
...
game:GetService("ReplicatedStorage").Events.Pet2Func:InvokeServer(unpack(args))
...
game:GetService("ReplicatedStorage").Events.Pet2Func:InvokeServer(unpack(args))
    ...
    AutoFpetSection:NewButton("Combine All Bears (5 gems)", "Combines all Bears in inventory", function()
    local args = {
    [1] = "Upgrade",
    [2] = {
        [1] = "basic_bear",
...
game:GetService("ReplicatedStorage").Events.Pet2Func:InvokeServer(unpack(args))
    ...
    local AutoSfarmSection = Tab:NewSection("Mars World Pets")

    AutoSfarmSection:NewToggle("Auto farm best pets (Mars)", "just auto farms pets and delets the bad pets", function(state)
        if state then
            Auto_Buy = true
            while Auto_Buy == true do
            wait()    
    ...
    AutoSfarmSection:NewToggle("Delete all mars world pets but not the ", "Delete all mars world pets but not the ", function(state)
        if state then
            AutoMD = true
            while AutoMD == true do
            wait()  
    ...
    AutoSfarmSection:NewButton("Combines all  (5 gems)", "Just combines ", function()
        print("Clicked")
    end)
end
...
local Tab = Window:NewTab("SCP 3008")
local maincSection = Tab:NewSection("Random stuff")

maincSection:NewButton("Third Person View", "Third Person", function()
    game.Players.LocalPlayer.CameraMaxZoomDistance = 50
   game.Players.LocalPlayer.CameraMode = Enum.CameraMode.Classic
end)


maincSection:NewToggle("ToggleText", "ToggleInfo", function(state)
    if state then
        print("Toggle On")
    else
        print("Toggle Off")
...
local FloppaSection = Tab:NewSection("Computer Shop")

FloppaSection:NewDropdown("Buy Stuff", "You have to have money to get", {"Floppa Food","Roommate", "Scratching Post", "Cool Hat", "Cat Bed", "Ms. Floppa", "Divorce Papers", "Baby Bowl", "Milk Dish", "Milk", "Neko Maid", "Stupid Bingus", "The Homie Sogga", "Neko Maid 2.0", "Catnip Plant", "Poop Fertilizer", "Floppa Sword", "Floppa Shield", "bigfootjinx", "Floppa Gunner", "Floppa Gunner 2", "Pop Cat", "Grumpy Cat", "Altar", "Mysterious Orb", "Time Machine"}, function(Purchase1)
wait()
local args = {
    [1] = (Purchase1)
}
...
FloppaSection:NewDropdown("Merchant Shop", "You have to have money to get", {"Destroyer", "Almond Water", "Recycle Bin", "Auto Saver"}, function(Purchase2)
    local args = {
        [1] = (Purchase2)
    }
    
    game:GetService("ReplicatedStorage").Purchase2:FireServer(unpack(args))
end)
...
local RequestRSection = Tab:NewSection("RoomMate")
RequestRSection:NewToggle("Request Rent", "Requets Rent to roommate", function(state)
    if state then
    RequestRent = true
    while RequestRent == true do
        wait()
...
RequestRSection:NewToggle("Request Raise", "ToggleInfo", function(state)
    if state then
        RequestRaise = true
        while RequestRaise == true do
            wait()
...
FloppaSection:NewLabel("Teleports")

FloppaSection:NewButton("TP Garden", "Teleports to Garden", function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-25, 0.600000381, -50.5, 0, 0, 1, 0, 1, -0, -1, 0, 0)
end)

FloppaSection:NewButton("TP Backrooms", "Teleports to Backrooms", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-12800.7217, 59.0350304, -16092.8994, -0.601814151, 0, 0.798636556, 0, 1, 0, -0.798636556, 0, -0.601814151)
end)

FloppaSection:NewButton("TP Backrooms Merchant", "Teleports to Backroom Merchant", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-12605.7803, 56.484787, -16108.7021, 0.601736665, -0, -0.79869467, 0, 1, -0, 0.79869467, 0, 0.601736665)
end)

FloppaSection:NewButton("TP UFO", "Teleports to Alien UFO", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(14.7750015, -82, 400, 0, 0, -1, 0, 1, 0, 1, 0, 0)
end)

FloppaSection:NewButton("TP House", "ButtonInfo", function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-66.2029266, 4.9440794, -37.6405334, 0.0193860047, -0.00328310183, 0.999806702, 0.0040305825, 0.999986768, 0.00320554106, -0.99980396, 0.00396766048, 0.0193989817)
    end)
end
...
local KATSection = Tab:NewSection("KAT Owl Hub")
KATSection:NewButton("Load Owl Hub", "loads owl hub", function()
...
if game.PlaceId == 292439477 then
    ...
    local PhantomSection = Tab:NewSection("Phantom Forces")
    PhantomSection:NewButton("Ceri | Legit Cheat (Press right shift when done)", "Press shift to hide", function()
        loadstring(game:HttpGet("https://ducksite.xyz/ceri/main.lua"))()
    end)

    PhantomSection:NewButton("Dark Hub Phandom Forces", "Script for Phantom Forces", function()
...
if game.PlaceId == 6229116934 then
    ...
    local HoopzSection = Tab:NewSection("Hoopz script")
    HoopzSection:NewButton("Hoopz Script", "Script", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/VenkiV2/Main-Hub/main/Hoopz?token=GHSAT0AAAAAABUIPAYJ7QOPXB2PJHPJI5REYTVPKMA"))()
    end)
end

if game.PlaceId == 286090429 then
    local Tab = Window:NewTab("Arsenal")
    local ArsenalSection = Tab:NewSection("Arsenal | Owl Hub")
    ArsenalSection:NewButton("Owl Hub", "Owl Hub", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))()
    end)

    ArsenalSection:NewButton("Dark Hub Arsenal", "Script for Arsenal", function()
        SupportedGames=game:GetService('HttpService'):JSONDecode(game:HttpGet('https://raw.githubusercontent.com/RandomAdamYT/DarkHub/master/SupportedGames'));
        for _,v in pairs(SupportedGames)do
        if game.PlaceId==tonumber(v)then
            loadstring(game:HttpGet('https://raw.githubusercontent.com/RandomAdamYT/DarkHub/master/'.._))()
...
if game.PlaceId == 2753915549 then
    ...
    BloxSection:NewButton("Blox Fruit", "Blox Hub", function()
...
if game.PlaceId == 4779613061 then
    local Tab = Window:NewTab("South London 2")
    local SouthSection = Tab:NewSection("South London 2")
    SouthSection:NewButton("South London 2", "Script", function()
        loadstring((request or http_request or syn and syn.request)({Url='https://raw.githubusercontent.com/antikur/SouthGay2/main/meCool',Method='GET'}).Body)()
    end)
end

if game.PlaceId == 4734949248 then
    local Tab = Window:NewTab("Demon Slayer RPG 2")
    local DemonSection = Tab:NewSection("Demon Slayer RPG 2")
    DemonSection:NewButton("Shitty DSRPG2 Gui", "By Terebi#0001 v0.57", function()
...
local JailSection = Tab:NewSection("Jailbreak")

JailSection:NewButton("Jailbreak autofarm gui", "Autofarm jailbreak", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/wawsdasdacx/ohascriptnrrewading/main/jbsaxcriptidk1"))()
end)

JailSection:NewButton("Dark Hub", "Darkhub Jailbreak", function()
    SupportedGames=game:GetService('HttpService'):JSONDecode(game:HttpGet('https://raw.githubusercontent.com/RandomAdamYT/DarkHub/master/SupportedGames'));
        for _,v in pairs(SupportedGames)do
        if game.PlaceId==tonumber(v)then
            loadstring(game:HttpGet('https://raw.githubusercontent.com/RandomAdamYT/DarkHub/master/'.._))()
...
local YBASection = Tab:NewSection("YBA")

YBASection:NewButton("YBA GUI (wait 10 seconds for the script)", "lots of things", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/NukeVsCity/hackscript123/main/gui")()
end)

YBASection:NewTextBox("Check 3 dots on right", "Input a delay in seconds and a item farm will apear", function(txt)
YBASection:NewButton("YBA Item Farm (Server Hops)", "Item farm that server hops", function()
getgenv().Itemfarm = true
getgenv().Invis = true
getgenv().WaitTime = (txt) --0.25 for Players with under 80Ping and 0.3 / 0.4 for everything higher
loadstring(game:HttpGet("https://raw.githubusercontent.com/Tobias020108Back/YBA-AUT/main/New-Itemfarm-Yba.lua"))()
end)
end)

YBASection:NewButton("Copy item farm script link to clipboard", "Paste into your browser", function()
    setclipboard("https://raw.githubusercontent.com/Tobias020108Back/YBA-AUT/main/New-Itemfarm-Yba.lua")
    
    CoreGui:SetCore("SendNotification", {
        -- Customizable
        Title = "YBA Script",
        Text = "Copyed YBA script link",
        Duration = 5, -- Set the duration to how much you want this to stay
        -- More code in part 2
    })
end)

YBASection:NewButton("Copy YBA GUI script link to clipboard", "Paste into your browser", function()
    setclipboard("https://raw.githubusercontent.com/NukeVsCity/hackscript123/main/gui")
...
local DaSection = Tab:NewSection("Da Hood")
DaSection:NewButton("Da Hood GUI", "A Da Hood GUI", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/PolarWasHere/Arctic/main/Arctic"))()
end)

DaSection:NewButton("Da Hood Silent Aim/ESP/Aimbot", "A Da Hood Silent Aim/ESP/Aimbot", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))()
end)
...
if game.PlaceId == 1224212277 then
    ...
    local MadSection = Tab:NewSection("Mad City")
    
    MadCityScript = "https://raw.githubusercontent.com/Eazvy/Mad-City-Advanced-Autofarm/main/Autofarm.lua"
    
    MadSection:NewButton("Mad City autofarm (Server Hops)", "Mad City autofarm", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Eazvy/Mad-City-Advanced-Autofarm/main/Autofarm.lua"))()
    end)
    MadSection:NewButton("Copy autofarm link to clipboard", "Paste into your browser", function()
        setclipboard(MadCityScript)
        CoreGui:SetCore("SendNotification", {
            -- Customizable
            Title = "Mad City Script",
            Text = "Copyed Mad City script link",
            Duration = 5, -- Set the duration to how much you want this to stay
            -- More code in part 2
        })
    end)
...
if game.PlaceId == 2317712696 then
    local Tab = Window:NewTab("The Wild West")
    local WildSection = Tab:NewSection("The Wild West")
    WildSection:NewButton("The Wild West MODS", "The Wild West MODS", function()
...
if game.PlaceId == 4111023553 then
    ...
    local DeepSection = Tab:NewSection("Deepwoken")
    DeepSection:NewButton("Deepwoken Script", "Deepwoken Script", function()
        loadstring(game:HttpGet('https://pastebin.com/raw/w8qQ07Pm'))()
    end)
end

if game.PlaceId == 8916037983 then
    local Tab = Window:NewTab("Starving artists")
    local StarSection = Tab:NewSection("Starving artists")
    StarSection:NewButton("Starving artists Copy Painting", "Starving artists", function()
        loadstring(game:HttpGet('https://pastebin.com/raw/w8qQ07Pm'))()
    end)
end
...
UtilSection:NewButton("Chat Logger", "Shows a gui with the chat", function()
